...
def get_orphans(MARKET: str = 'SNP',
    ...
    df_ch8 = df_ch8.assign(pnl=df_ch8.revenue -
                           df_ch8.avgCost * df_ch8.lot * df_ch8.qty)
    ...
    missing_und_symbols = [s for s in orph if s not in list(
        df_raw_orphs.symbol.unique())]
    ...
    saveObject = {'df_orphans': df_orphans, 'df_close': df_close,
                  'df_raw_orphans': df_raw_orphs, 'missing': missing_und_symbols}
